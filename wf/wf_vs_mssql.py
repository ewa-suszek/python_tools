...
def main():
    ...
    cycles_id_list_mssql = get_mssql_data('gksisql017n1.ger.corp.intel.com,3181', 'GSE_CI', 'SELECT cycle_id,start_date,status_date FROM [GSE_CI].[dbo].[smoke_ci_cycles]')
    sessions_id_list_mssql = get_mssql_data('gksisql017n1.ger.corp.intel.com,3181', 'GSE_CI', 'SELECT session_id,start_date,status_date FROM [GSE_CI].[dbo].[smoke_ci_sessions]')
